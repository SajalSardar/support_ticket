<button wire:loading.attr="disabled" {{ $attributes->merge(['type' => 'submit', 'class' => 'h-[40px] font-inter text-base font-medium text-[#5e666e] transition-colors hover:bg-primary-400 flex justify-center items-center hover:text-white border border-base-500 px-8 py-[7px] bg-[#f3f4f6] rounded']) }}>
