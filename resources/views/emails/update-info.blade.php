    ...
    >
      ...
      <tr>
        <td class="content">
          ...
          <p class="titleHeading" style="padding-left: 4px">Hello John,</p>
          ...
          >
            ...
            <tr>
              <td><span class="titleHeading">Request ID :</span> RQ20240123</td>
            </tr>
            <tr>
              <td>
                <span class="titleHeading">Due Date:</span> Dec 30, 2024, 10:45
                AM
              </td>
            </tr>
            <tr>
              <td><span class="titleHeading">Email :</span> @gmail.com</td>
            </tr>
            <tr>
              <td>
                <span class="titleHeading">Password :</span> ****************
              </td>
            </tr>
            <tr>
              <td>
                <span class="titleHeading">Category :</span>Technical Support
              </td>
            </tr>
            <tr>
              <td><span class="titleHeading">Priority :</span>High</td>
            </tr>
            <tr>
              <td>
                 <span class="titleHeading">Description :</span> Unable to log in to my account due to a password
                reset error.
              </td>
            </tr>
          </table>
