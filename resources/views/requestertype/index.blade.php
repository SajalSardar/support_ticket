<x-app-layout>
    ...
    @include('requestertype.breadcrumb.index')
    <div class="flex justify-between items-center !mt-3">
        <div class="flex-1 mt-1">
            <div class="flex justify-end gap-3">
                @can('requestertype create')
                <div>
                    <x-actions.href href="{{ route('admin.requestertype.create') }}" class="block">
        ...
        <table class="display nowrap" id="data-table" style="width: 100%;border:none;">
            <thead style="background:#F3F4F6; border:none">
                <tr>
                    ...
                    <th class="text-heading-dark">Requester Type</th>
    ...
    <script>
        $(function() {
            var dTable = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.requesterType.list.datatable') }}",
                    type: "GET",
                },
                columns: [{
                        data: 'select',
