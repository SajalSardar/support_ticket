        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            <div class="flex h-full justify-center items-center sm:px-5 sm:py-12 md:px-10 md:py-24 lg:px-20 lg:-mr-14">
                <form action="{{ route('register') }}" method="POST" class="border border-base-500 rounded p-6 w-full">
                    ...
                    <div class="">
                        <div class="mt-3">
                            <x-forms.text-input-icon style="width: 100%;" type="text" name="name" placeholder="Name"
                                dir="start">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#5e666e" stroke-width="1.5" />
                                </svg>
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_1_4773)">
                                        <path
                                            ...
                                            stroke="#5e666e" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M22 6L12 13L2 6" stroke="#5e666e" stroke-width="1.5"
                    ...
                    <div>
                        <div class="mt-3">
                            <x-forms.password type="password" id="passTypeChange" name="password"
                    ...
                    <div>
                        <div class="mt-3">
                            <x-forms.confirm-password type="password" id="passTypeChangeConfirm"
                    ...
                    <div class="mt-2">
                        <a href="#" class="inline-block border border-base-500 rounded-lg p-3 w-full text-center">
                            ...
                            <span class="sm:hidden md:inline-block text-center text-paragraph">Sign up with
                                Google</span>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute top-10 left-12 pe-14">
                            ...
                            <p class="text-title text-justify">
                                ...
                                is a customer service platform that streamlines communication, enabling businesses to
                                efficiently manage and resolve customer requests in real-time, ensuring prompt responses
