<x-guest-layout>
    ...
    <div class="flex h-full sm:justify-center lg:justify-center md:justify-center items-center">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            <div
                class="flex justify-center sm:px-5 sm:py-12 md:px-10 md:py-24 lg:px-20 lg:py-32 items-center lg:-mr-14">
                <form method="POST" action="{{ route('login') }}" class="border border-base-500 rounded p-6 w-full">
                        ...
                        <x-forms.text-input-icon type="email" name="email" placeholder="Email Address"
                            ...
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                ...
                                <g clip-path="url(#clip0_1_4773)">
                                    ...
                                    <path d="M22 6L12 13L2 6" stroke="#5e666e" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </g>
                                <defs>
                    ...
                    <div class="mt-3 flex justify-between">
                        ...
                        <p class="">
                            <span>
                                <a class="text-paragraph" href="{{ route('password.request') }}">{{ __('Forgot Password
                                    ?') }}</a>
                            </span>
                        </p>
                    </div>
                    ...
                    {{-- <div class="mt-3">
                        <a href="#" class="inline-block border border-base-500 rounded-lg p-[6px] w-full text-center">
                            <svg class="inline-block" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0_810_3051" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                            ...
                            <span class="sm:hidden md:inline-block text-center text-paragraph">Sign in with
                                Google</span>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute top-10 left-12 pe-14">
                            ...
                            <p class="text-title">
                                ...
                                is a customer service platform designed to help businesses efficiently track, manage,
                                and resolve customer requests in real time. Our mission is to streamline communication
                                and ensure every query is addressed promptly, enhancing customer satisfaction.
                            </p>
                        </div>
                    </div>
                </div>
